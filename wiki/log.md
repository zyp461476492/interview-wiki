...
## [2026-08-05] ingest | MySQL
- 新增登记题目 2 道（mysql-014 唯一索引冲突/insert 的 S 锁与 X 锁互斥、mysql-015 高并发批量更新唯一索引的问题与规避，含参考答案）
- 同步更新：知识体系锁机制考点补充（唯一索引冲突 S/X 互斥、高并发批量更新）、题目索引表追加 2 行、frontmatter question_count 13 -> 15、index.md 题量 13 -> 15
- 来源：用户请求（会话补充，2026-08-05），承接 mysql-009 死锁场景细化唯一索引 S/X 锁机制并延伸批量更新场景

## [2026-08-05] ingest | MySQL
- 新增登记题目 1 道（mysql-016 高并发批量插入的问题与规避，含参考答案）
- 同步更新：知识体系锁机制考点补充（批量插入与 AUTO-INC 自增锁）、题目索引表追加 1 行、frontmatter question_count 15 -> 16、index.md 题量 15 -> 16
- 来源：用户请求（会话补充，2026-08-05），承接 mysql-014/015 唯一索引锁机制，补充批量插入场景（自增锁/唯一键冲突/插入意向锁/大事务）
